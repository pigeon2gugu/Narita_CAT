...
colormesh = m.pcolormesh(x, y, tend[1,:,:], vmin = -10, vmax = 10, cmap=cmap)
cs=m.contour(x,y,nvo500[1,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
uproj,vproj,xx,yy = m.transform_vector(su[1,:,:],sv[1,:,:],newlon1,lat1,10,10,returnxy=True,masked=True)
x2 , y2 = m(xx, yy)
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, hadv[1,:,:], vmin = -14, vmax = 14, cmap=cmap)
cs=m.contour(x,y,nvo500[1,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, vadv[1,:,:], vmin = -6, vmax = 6, cmap=cmap)
cs=m.contour(x,y,nvo500[1,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, stre[1,:,:], vmin = -6, vmax = 6, cmap=cmap)
cs=m.contour(x,y,nvo500[1,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, tilt[1,:,:], vmin = -6, vmax = 6, cmap=cmap)
cs=m.contour(x,y,nvo500[1,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
fig = plt.savefig('./figures/vorticity tendency_29_2')
