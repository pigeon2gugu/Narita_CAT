...
colormesh = m.pcolormesh(x, y, tend[0,:,:], vmin = -4, vmax = 4, cmap=cmap)
cs=m.contour(x,y,hthe400[0,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, hadv[0,:,:], vmin = -4, vmax = 4, cmap=cmap)
cs=m.contour(x,y,hthe400[0,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, vadv[0,:,:], vmin = -4, vmax = 4, cmap=cmap)
cs=m.contour(x,y,hthe400[0,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, hd[0,:,:], vmin = -4, vmax = 4, cmap=cmap)
cs=m.contour(x,y,hthe400[0,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
m.plot(x1, y1, color='r', marker='*')
cmap = mpl.cm.bwr
colormesh = m.pcolormesh(x, y, tilt[0,:,:], vmin = -4, vmax = 4, cmap=cmap)
cs=m.contour(x,y,hthe400[0,:,:], clevs1, colors='black', linewidths = 1.5, linestyles='--')
cbar=m.colorbar(colormesh)
plt.clabel(cs, fmt='%3.0f', colors='black', fontsize = 7)
...
#plt.show()
fig = plt.savefig('./figures/frontogenesis tendency_28')
