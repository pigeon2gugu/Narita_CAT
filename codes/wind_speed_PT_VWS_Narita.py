...
for i in range(11):
	...
	clevs1= np.arange(0,26,2)
	VWS[ VWS > max(clevs1) ] = max(clevs1)
	...
	cs1 = plt.contourf(y, x, VWS[i,480:541,1:31,1], clevs1,  cmap = cmap)
	...
	cbar.ax.set_yticklabels(['0','4','8','12','16','20','>24'])
	cbar.set_label('Virtical Wind shear 10^{-3}/s', fontsize = 7)
	plt.gca().invert_yaxis()

plt.subplots_adjust(wspace = 0.42, hspace = 0.30)
fig = plt.savefig('./figures/windspeed_PT_VWS_Narita_20181028_29_30')
