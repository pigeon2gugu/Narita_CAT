...
abv = np.zeros((11,32,721,3))
dthe = np.zeros((11,32,721,3))
...
for i in range(11):
	...
	cbar.set_label('Potentia Vorticity Unit $(10^{-6}K*m^{2}/kg*s)$', fontsize = 7)
	plt.gca().invert_yaxis()

plt.subplots_adjust(wspace = 0.42, hspace = 0.30)
fig = plt.savefig('./figures/windspeed_PT_PVU_Narita_20181028_29_30')
