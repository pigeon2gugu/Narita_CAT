...
for i in range(11):
	...
	clevs1= np.arange(0,5.5,0.5)
	Ns[ Ns > max(clevs1) ] = max(clevs1)
	...
	cs1 = plt.contourf(y, x, Ns[i,480:541,1:31,1],clevs1, cmap = cmap)
	...
	cbar.set_label('Brunt-Vaisala frequency 10^{-4}/s^{2}', fontsize = 7)
	plt.gca().invert_yaxis()

plt.subplots_adjust(wspace = 0.42, hspace = 0.30)
fig = plt.savefig('./figures/windspeed_PT_Ns_Narita_20181028_29_30')
